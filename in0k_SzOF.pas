...
procedure SzOF_listFT2F_zFIX(const fTop,form:TCustomForm; var list:tListFT2F); {$ifOPT D-}inline;{$endIf}
...
procedure SzOF_listFT2F_zFIX(const fTop,form:TCustomForm; var list:tListFT2F);
var i:integer;
begin {$ifOPT D+}
